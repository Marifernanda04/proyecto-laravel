...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
    ...
    <header class="bg-gradient" id="home">
        <div class="container mt-5">
            <h1>Tattoo App</h1>
            <p class="tagline">Les presentamos una aplicacion innovadora</p>
        </div>
    ...
    <div class="section light-bg" id="features">
        ...
        <div class="container">
            ...
            <div class="section-title">
                <h3>Ventajas que te haran amar la aplicacion</h3>
            </div>
                    ...
                    <div class="card features">
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="card-title">Personalizacion</h4>
                                    <!--<p class="card-text"> </p>-->
                                </div>
                            </div>
                        </div>
    ...
    <div class="section light-bg">
        <div class="container">
            <div class="section-title">
                <small>MEJORAS</small>
                <h3>Haz mas con nuestra aplicacion</h3>
            </div>

            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#communication">Comunicacion</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#schedule">Agenda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#messages">Mensajes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#livechat">Videollamadas</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane fade show active" id="communication">
                    <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div>
                            ...
                            <h2>Comunicacion con mas facilidad</h2>
                ...
                <div class="tab-pane fade" id="schedule">
                    <div class="d-flex flex-column flex-lg-row">
                        <div>
                            <h2>Agenda cuando tu quieras</h2>
                            <p class="lead">Uniquely underwhelm premium outsourcing with proactive leadership skills. </p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer rutrum, urna eu pellentesque pretium, nisi nisi fermentum enim, et sagittis dolor nulla vel sapien. Vestibulum sit amet mattis ante. Ut placerat dui eu nulla
                                congue tincidunt ac a nibh. Mauris accumsan pulvinar lorem placerat volutpat. Praesent quis facilisis elit. Sed condimentum neque quis ex porttitor,
                            </p>
                ...
                <div class="tab-pane fade" id="messages">
                    <div class="d-flex flex-column flex-lg-row">
                        <img src="images/graphic.png" alt="graphic" class="img-fluid rounded align-self-start mr-lg-5 mb-5 mb-lg-0">
                        <div>
                            <h2>Servicio de mensajeria en tiempo real</h2>
                            <p class="lead">Aplicacion unica con herramientas perfectas para lider </p>
                            <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer rutrum, urna eu pellentesque pretium, nisi nisi fermentum enim, et sagittis dolor nulla vel sapien. Vestibulum sit amet mattis ante. Ut placerat dui eu nulla
                                congue tincidunt ac a nibh. Mauris accumsan pulvinar lorem placerat volutpat. Praesent quis facilisis elit. Sed condimentum neque quis ex porttitor,
                            </p>
                            <p> malesuada faucibus augue aliquet. Sed elit est, eleifend sed dapibus a, semper a eros. Vestibulum blandit vulputate pharetra. Phasellus lobortis leo a nisl euismod, eu faucibus justo sollicitudin. Mauris consectetur, tortor
                ...
                <div class="tab-pane fade" id="livechat">
                    <div class="d-flex flex-column flex-lg-row">
                        <div>
                            <h2>Videollama cuando lo necesites</h2>
                            <p class="lead">Uniquely underwhelm premium outsourcing with proactive leadership skills. </p>
                            <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer rutrum, urna eu pellentesque pretium, nisi nisi fermentum enim, et sagittis dolor nulla vel sapien. Vestibulum sit amet mattis ante. Ut placerat dui eu nulla
                                congue tincidunt ac a nibh. Mauris accumsan pulvinar lorem placerat volutpat. Praesent quis facilisis elit. Sed condimentum neque quis ex porttitor,
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div>
                        ...
                        <h2>Inicia tu App</h2>
                        <p class="mb-4">Inicia tu app con las mejores funciones</p>
                    ...
                    <ul class="list-unstyled ui-steps">
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Crea tu cuenta en nuestra app para mejores beneficios </p>
                            </div>
                        </li>
                        <li class="media my-4">
                            <div class="circle-icon mr-4">2</div>
                            <div class="media-body">
                                <h5>Comparte con amigos</h5>
            ...
            <div class="card-deck">
                <div class="card pricing">
                    ...
                    <ul class="list-group list-group-flush">
                        <div class="list-group-item">10 Proyectos</div>
                        <div class="list-group-item">5 GB Almacenamiento</div>
                        <div class="list-group-item">Sopporte Basico</div>
                        <div class="list-group-item"><del>Colaboracion</del></div>
                        <div class="list-group-item"><del>Reportes y Analisis</del></div>
                    </ul>
                    <div class="card-body">
                        <a href="#" class="btn btn-primary btn-lg btn-block">Elige este plan</a>
                    </div>
                </div>
                <div class="card pricing popular">
                    <div class="card-head">
                        <small class="text-primary">Para equipos</small>
                        <span class="price">$29<sub>/m</sub></span>
                    </div>
                    <ul class="list-group list-group-flush">
                        <div class="list-group-item">Proyectos ilimitados</div>
                        <div class="list-group-item">100 GB de almacenamiento</div>
                        <div class="list-group-item">Priority Support</div>
                        <div class="list-group-item">Colaboracion</div>
                        <div class="list-group-item">Reportes y analisis</div>
                    </ul>
                    <div class="card-body">
    ...
    <!--<divclass="light-bg py-5" id="contact">
        <div class="container">
            <div class="row">
